...
export class OPLS {
    ...
    output: {
        ...
        predictiveLoadings: Matrix;
        predictiveWeights: Matrix;
        betas: Matrix;
        Qpc: Matrix;
        predictiveScoresCV: Matrix[];
        orthogonalScoresCV: Matrix[];
        yHatScoresCV: Matrix[];
        oplsCV: never[][];
        orthogonalScores: Matrix;
        orthogonalLoadings: Matrix;
        orthogonalWeights: Matrix;
        Xorth: Matrix;
        yHat: any;
        Yres: any;
        residualData: Matrix;
