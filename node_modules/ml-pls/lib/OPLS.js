...
const ml_confusion_matrix_1 = __importDefault(require("ml-confusion-matrix"));
    ...
    predict(features, options = {}) {
        ...
        if (labels?.rows > 0) {
            if (this.mode === 'regression') {
                ...
                const confusionMatrix = ml_confusion_matrix_1.default.fromLabels(trueLabels, totalPred.to1DArray());
