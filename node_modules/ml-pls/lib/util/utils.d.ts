 ...
 * */
export function pow2array(i: number, j: number): Matrix;
/**
 * @private
 ...
 */
export function featureNormalize(dataset: Matrix): object;
/**
 * @private
 ...
 */
export function initializeMatrices(array: any[], isMatrix: boolean): any[];
